...
<title>Zaria Exclusive Car Rental</title>
<!--Bootstrap -->
...
<section class="section-padding gray-bg">
  <div class="container">
    <div class="section-header text-center">
      ...
      <p>Ditch the GPS, embrace the "lost" in "lost and found." Every wrong turn is a right adventure, every dusty side road a gateway to hidden gems. Unfold the map, but let your heart be the compass. Rent your compass today.</p>
    </div>
    <div class="row"> 
