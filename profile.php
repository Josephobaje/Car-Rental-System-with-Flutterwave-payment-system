...
<title>Zaria Exclusive Car Rental | My Profile</title>
<!--Bootstrap -->
          ...
          <form  method="post">
           <div class="form-group">
            ...
            <div class="form-group">
              ...
              <input class="form-control white_bg" name="mobilenumber" value="<?php echo htmlentities($result->ContactNo);?>" id="phone-number" type="text" required readonly>
            </div>
            <div class="form-group">
